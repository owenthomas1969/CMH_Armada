...
begin
  ...
  l_varchar2(4) :=q'!14.11.2016 19:56:27.110936000 +00:00!';
  l_clob(5) :=q'!ROY.MALTO@MIDDLEMORE.CO.NZ!';
  l_varchar2(6) :=q'!14.11.2016 19:56:27.111227000 +00:00!';
  l_clob(7) :=q'!ROY.MALTO@MIDDLEMORE.CO.NZ!';
  l_varchar2(8) :=q'!3!';
  l_clob(9) :=q'!!';
...
begin
  ...
  l_varchar2(4) :=q'!26.11.2017 20:05:59.848733000 +00:00!';
  l_clob(5) :=q'!ROY.MALTO@MIDDLEMORE.CO.NZ!';
  l_varchar2(6) :=q'!26.11.2017 20:05:59.848759000 +00:00!';
  l_clob(7) :=q'!ROY.MALTO@MIDDLEMORE.CO.NZ!';
  l_varchar2(8) :=q'!2!';
  l_clob(9) :=q'!!';
